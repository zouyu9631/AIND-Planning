...
class AirCargoProblem(Problem):
    ...
    def get_actions(self):
            ...
            for c in self.cargos:
                for p in self.planes:
                    for a in self.airports:
                        ...
                        loads.append(load)
            # loads = ['Load({}, {}, {})'.format(c, p, a) for c in self.cargos for p in self.planes for a in self.airports]
            return loads
        ...
        def unload_actions():
            ...
            # unloads = ['Unload({}, {}, {})'.format(c, p, a) for c in self.cargos for p in self.planes for a in self.airports]
            return unloads
